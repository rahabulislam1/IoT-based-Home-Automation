...
#include <Servo.h>
SoftwareSerial GPRS(37,38);
boolean AlarmState,AlarmlastState,FireState,FirelastState;
Servo myServo;
...
//////////////
 ...
 //pinMode(2,INPUT_PULLUP);
  AlarmState=digitalRead(A0);
  FireState=digitalRead(39);
  AlarmlastState=AlarmState;
  FirelastState=FireState;
 // AlarmState,AlarmlastState,FireState,FireLastState;
 ...
 */
 ...
 delay(500);
  ...
  if (voice.length() > 0) {
    ...
    else if (voice == "*b light on") {
      digitalWrite(led3, HIGH); //b light on
    }
    else if (voice == "*b fan on") {
      digitalWrite(led4, HIGH);
    }
    ...
    else if (voice == "*b light off") {
      digitalWrite(led3, LOW);
    }
    else if (voice == "*b fan off") {
      digitalWrite(led4, LOW);
    }
...
void enterPassword() {
  ...
  void sendSMSForAlarm(){
  Serial.print("Home UnSecured");
//  Serial.println(state?"on":"off");
  GPRS.println("AT+CMGF=1");
  delay(500);
  GPRS.println("AT+CMGS=\"+8801521444047\"");
  delay(500);
  GPRS.println("Dear Palace Owner,\nAlarm is ON.\nYou Palace is UnSecured Now.\nPlease call police.");
  ...
  delay(500);
    ...
    void sendSMSForFire(){
  Serial.print("Home Fire");
//  Serial.println(state?"on":"off");
  GPRS.println("AT+CMGF=1");
  delay(500);
  GPRS.println("AT+CMGS=\"+8801521444047\"");
  delay(500);
  GPRS.println("Dear Palace Owner,\nYou Palace is attacted by Fire.\nPlease call Fire Service.\nFire Service No 01521417895.");
  //GPRS.println(state?"on":"off");
  GPRS.write(0x1a);
  delay(500);
